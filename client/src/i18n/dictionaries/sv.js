...
aboutLeaderboard: {
  ...
  hNotes: "Bra att veta",
  p5: "Alla-vyn visar alla svårighetsgrader, sorterad efter SCORE. Du kan om du vill sortera efter ELO.",
},
...
aboutXp: {
  ...
  dialogs: {
    ...
    challengeWentOffline: "{to} gick offline / tappade anslutningen.",
